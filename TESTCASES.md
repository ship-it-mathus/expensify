...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `TC-ROOT-001` | API Health Check | Verifies root endpoint returns online status message and docs URL. | `GET /` | `200 OK` | [`test_tc_root_001_root_health_check`](file:///Users/mathews/Projects/Expensify/tests/test_main.py#L1-L8) |
